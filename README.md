...
3. **可见性判断：** 每个数据版本都标记有创建它的事务 ID（T_{start}）和删除它的事务 ID（T_{end}）。事务 T_{read} 根据其启动时的 **Read View**（活跃事务集合），判断哪个版本对它是“可见”的。
...
> [直接看这篇文章](https://ivanzz1001.github.io/records/post/data-structure/2018/06/16/ds-bplustree#31-b%E6%A0%91%E6%8F%92%E5%85%A5%E7%A4%BA%E4%BE%8B)
